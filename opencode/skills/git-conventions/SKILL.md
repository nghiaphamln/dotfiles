...
description: "Use when creating branches, naming branches, preparing commits, writing commit messages, or applying Conventional Commits. Inspect project-local conventions first; this dotfiles repo has specific scopes and safety rules."
---

# Git Conventions

Use these rules when creating branches or preparing commits. First inspect project-local conventions such as `AGENTS.md`, `CONTRIBUTING.md`, release docs, and recent commits. If local conventions conflict with this skill, local conventions win.

The dotfiles-specific scopes and safety rules below apply when the current repository is this dotfiles repo.
...
For this dotfiles repo, prefer scopes that match top-level tools or shared areas:
...
In this dotfiles repo, never commit:
